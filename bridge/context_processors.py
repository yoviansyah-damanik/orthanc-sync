    ...
    menu_structure = [
        ...
        },
        {
            ...
            'items': [
                ...
                {
                    'name': 'Info Orthanc',
                    'url': 'orthanc_info_page',
                    'icon': '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 3H5a2 2 0 00-2 2v4m6-6h10a2 2 0 012 2v4M9 3v18m0 0h10a2 2 0 002-2V9M9 21H5a2 2 0 01-2-2V9m0 0h18"></path>'
                },
                {
                    'name': 'Konfigurasi',
