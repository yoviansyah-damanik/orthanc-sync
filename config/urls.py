...
from bridge.views import dicom_modify_api, routing_rules_api, sync_schedules_api, routing_logs_api, sync_logs_api, orthanc_viewer_url_api
...
from bridge.views import doc_modality_page_view, doc_modality_upload_api, doc_transfer_api, doc_delete_api, create_study_orthanc_api
...
urlpatterns = [
    ...
    path('api/study/create', create_study_orthanc_api, name='api_study_create'),
    ...
    path('api/orthanc-viewer-url/', orthanc_viewer_url_api, name='orthanc_viewer_url_api'),
